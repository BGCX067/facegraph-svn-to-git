...
var GexfJS = {
    ...
    i18n : {
        "pl" : {
            "search" : "Wyszukaj węzeł",
            "nodeAttr" : "Atrybuty",
            "nodes" : "Węzły",
            "inLinks" : "Krawędz wchodząca z :",
            "outLinks" : "Krawędz wychodząca do :",
            "undirLinks" : "Krawędz nieskierowana :",
            "lensOn" : "Włącz zbliżenie",
            "lensOff" : "Wyłącz zbliżenie",
            "edgeOn" : "Aktywuj krawędzie",
            "edgeOff" : "Dezaktywuj krawędzie",
            "zoomIn" : "Zbliż",
            "zoomOut" : "Oddal",
            ...
            "weighted indegree" : "Weighted in-degree",
            "weighted outdegree" : "Weighted out-degree",
            "closnesscentrality" : "Closness centrality",
            "betweenesscentrality" : "Betweeness centrality",
            "authority" : "Authority (HITS)",
            "hub" : "Hub (HITS)",
            "pageranks" : "PageRank"
        },
        "en" : {
...
function displayNode(_nodeIndex, _recentre) {
    ...
    if (_nodeIndex != -1) {
        ...
        _str += '<center><img src=http://graph.facebook.com/' + _d.id + '/picture?type=large \></center>';
...
function traceArc(contexte, source, target) {
    ...
    if (GexfJS.params.curvedEdges) {
        if ( ( source.x == target.x ) && ( source.y == target.y ) ) {
            ...
            var x3 = .3 * target.y - .5 * source.y + .8 * source.x + .2 * target.x;
